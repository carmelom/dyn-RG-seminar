...
\begin{frame}{Come si fa RG - trova un altro titolo}
  ...
  \begin{itemize}
   ...
   \begin{flalign*}
    \sigma_k(t) \mapsto s^{1-\eta/2}\ \sigma_{sk}(s^{-z}t) \Leftrightarrow \sigma_k(\omega) \mapsto s^{1-\eta/2 + z}\ \sigma_{sk}(s^z\omega)&&
   \end{flalign*}

  \end{itemize}

Infine, con il cambio di variabili $\{ \omega' = s^z \omega\ ;\ k' = sk \}$\\
